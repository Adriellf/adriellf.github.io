                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="Appointment">
                                <div class="book_btn d-none d-lg-block">
                                    <a  href="redcontact.php">Teste Grátis</a>
                                </div>
                            </div>
                        </div>  
                        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3>Genius Web</p></h3><br>
                    </div>
                    <div class="slider_text">
                        <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s">Sistema ideal para você controlar seu estoque, realizar vendas, <br>
                            fazer gestão financeira e emitir notas fiscais eletrônicas usando apenas um nagevador web.<br>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
                    ...
                    <div class="row  align-items-center">
                            <div class="col-xl-5 col-lg-5 col-md-6">
                                <div class="features_info2">
                                    <h3>Gráficos simples, porém precisos.</h3>
                                    <p>Tenha acesso a um painel simples e objetivo que lhe oferece visualizações gráficas dos principais indicadores de desempenho da sua empresa.</p>
                                </div>
                            </div>
                    ...
                    <div class="row  align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="features_info">
                                    <h3 class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s" >Controle seu estoque</h3>
                                    <p class="wow fadeInUp" data-wow-duration=".6s" data-wow-delay=".4s"  >O Genius Web controla todo o movimento do seu estoque, seja no movimento de venda, compra, devolução de cliente ou devolução de fornecedor. Assim você não precisa mais ficar perdido e perdendo tempo com planilhas.</p>
                                </div>
                            </div>
                    </div>
            </div>
            <div class="features_main_wrap">
                <div class="row  align-items-center">
                        <div class="col-xl-5 col-lg-5 col-md-6">
                            <div class="features_info">
                                <h3>Controle seu financeiro</h3>
                                <p>Com o Genius Web você tem controle de todo o seu financeiro:</p>
                                <ul>
                                    <li class="wow fadeInUp" data-wow-duration=".7s" data-wow-delay=".5s" ><b>1- Contas a Pagar e Pagas:</b> você pode fazer lançamentos das despesas de sua empresa e controlar tudo que você paga.</li>
                                    <li class="wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".6s" ><b>2- Contas a Receber e Recebidos:</b> controle todos os valores que você tem para receber de seus clientes. </li>
                                    <li class="wow fadeInUp" data-wow-duration=".7s" data-wow-delay=".5s" ><b>3- Receita Perdida:</b> você também pode gerenciar as contas a receber consideradas perdidas.</li>
                                    <li class="wow fadeInUp" data-wow-duration=".8s" data-wow-delay=".6s" ><b>4- Relatórios:</b> entenda seu financeiro através dos relatórios Centro de Resultado x Plano de Conta, Fluxo de Caixa e Formas de Pagamento. </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-5 offset-xl-1 offset-lg-1 col-md-6 ">
